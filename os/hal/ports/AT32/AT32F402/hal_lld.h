...
/**
 * @file    AT32F402/hal_lld.h
 * @brief   AT32F402 HAL subsystem low level driver header.
 ...
 *          - AT32F402KB for K Mainstream Medium Density devices.
 *          - AT32F402CB for C Mainstream Medium Density devices.
 *          - AT32F402RB for R Mainstream Medium Density devices.
 *          - AT32F402KC for K Mainstream High Density devices.
 *          - AT32F402CC for C Mainstream High Density devices.
 *          - AT32F402RC for R Mainstream High Density devices.
 *          .
 *
 * @addtogroup HAL
 * @{
...
#define PLATFORM_NAME               "AT32F402"

#elif defined(AT32F402K_MD)
#define PLATFORM_NAME               "AT32F402K Mainstream Line Medium Density"

#elif defined(AT32F402K_HD)
#define PLATFORM_NAME               "AT32F402K Mainstream Line High Density"

#elif defined(AT32F402C_MD)
#define PLATFORM_NAME               "AT32F402C Mainstream Line Medium Density"

#elif defined(AT32F402C_HD)
#define PLATFORM_NAME               "AT32F402C Mainstream Line High Density"

#elif defined(AT32F402R_MD)
#define PLATFORM_NAME               "AT32F402R Mainstream Line Medium Density"

#elif defined(AT32F402R_HD)
#define PLATFORM_NAME               "AT32F402R Mainstream Line High Density"
 ...
 */
#if !defined(AT32F402) || defined(__DOXYGEN__)
#define AT32F402
#endif
/** @} */
