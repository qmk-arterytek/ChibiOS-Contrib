...
/**
 * @file    AT32F405/hal_lld.h
 * @brief   AT32F405 HAL subsystem low level driver header.
 ...
 *          - AT32F405KB for K Mainstream Medium Density devices.
 *          - AT32F405CB for C Mainstream Medium Density devices.
 *          - AT32F405RB for R Mainstream Medium Density devices.
 *          - AT32F405KC for K Mainstream High Density devices.
 *          - AT32F405CC for C Mainstream High Density devices.
 *          - AT32F405RC for R Mainstream High Density devices.
 *          .
 *
 * @addtogroup HAL
 * @{
...
#define PLATFORM_NAME               "AT32F405"

#elif defined(AT32F405K_MD)
#define PLATFORM_NAME               "AT32F405K Mainstream Line Medium Density"

#elif defined(AT32F405K_HD)
#define PLATFORM_NAME               "AT32F405K Mainstream Line High Density"

#elif defined(AT32F405C_MD)
#define PLATFORM_NAME               "AT32F405C Mainstream Line Medium Density"

#elif defined(AT32F405C_HD)
#define PLATFORM_NAME               "AT32F405C Mainstream Line High Density"

#elif defined(AT32F405R_MD)
#define PLATFORM_NAME               "AT32F405R Mainstream Line Medium Density"

#elif defined(AT32F405R_HD)
#define PLATFORM_NAME               "AT32F405R Mainstream Line High Density"

#else
#error "unsupported or unrecognized AT32F405 member"
#endif

/**
 * @brief   Sub-family identifier.
 */
#if !defined(AT32F405) || defined(__DOXYGEN__)
#define AT32F405
#endif
/** @} */
...
#define AT32_CLKOUT_SEL1_CFG_MASK   (3 << 30)            /**< CLKOUT_SEL1 pin on CRM_CFG mask.   */
#define AT32_CLKOUT_SEL1_SCLK       (0 << 30)            /**< SCLK on CLKOUT_SEL1 pin.           */
#define AT32_CLKOUT_SEL1_HEXT       (2 << 30)            /**< HEXT clock on CLKOUT_SEL1 pin.     */
#define AT32_CLKOUT_SEL1_PLL        (3 << 30)            /**< PLL clock on CLKOUT_SEL1 pin.      */
/** @} */
...
#define AT32_CLKOUT_SEL2_MISC1_MASK (15 << 16)           /**< CLKOUT_SEL2 pin on CRM_MISC1 mask. */
#define AT32_CLKOUT_SEL2_USBFS      ((1 << 30) | (0 << 16))
                                                         /**< USBFS clock on CLKOUT_SEL2 pin.    */
#define AT32_CLKOUT_SEL2_ADC        ((1 << 30) | (1 << 16))
                                                         /**< ADC clock on CLKOUT_SEL2 pin.      */
#define AT32_CLKOUT_SEL2_HICK       ((1 << 30) | (2 << 16))
                                                         /**< HICK clock on CLKOUT_SEL2 pin.     */
#define AT32_CLKOUT_SEL2_LICK       ((1 << 30) | (3 << 16))
                                                         /**< LICK clock on CLKOUT_SEL2 pin.     */
#define AT32_CLKOUT_SEL2_LEXT       ((1 << 30) | (4 << 16))
                                                         /**< LEXT clock on CLKOUT_SEL2 pin.     */
#define AT32_CLKOUT_SEL2_USBHS      ((1 << 30) | (5 << 16))
...
/**
 * @brief   CLKOUT_SEL1 pin setting.
 */
#if !defined(AT32_CLKOUT_SEL1) || defined(__DOXYGEN__)
#define AT32_CLKOUT_SEL1            AT32_CLKOUT_SEL1_SCLK
#endif
...
/**
 * @brief   CLKOUT_SEL2 pin setting.
 */
#if !defined(AT32_CLKOUT_SEL2) || defined(__DOXYGEN__)
#define AT32_CLKOUT_SEL2            AT32_CLKOUT_SEL2_HICK
#endif
...
#if ((AT32_SCLKSEL == AT32_SCLKSEL_HICK) && (AT32_PLLRCS == AT32_PLLRCS_HICK))
#error "HICK not enabled, required by AT32_SCLKSEL and AT32_PLLRCS"
#endif

#if (AT32_CLKOUT_SEL2 == AT32_CLKOUT_SEL2_HICK) ||                          \
    ((AT32_CLKOUT_SEL1 == AT32_CLKOUT_SEL1_PLL) &&                          \
     (AT32_PLLRCS == AT32_PLLRCS_HICK))
#error "HICK not enabled, required by AT32_CLKOUT_SEL1 or AT32_CLKOUT_SEL2"
#endif
...
#if (AT32_CLKOUT_SEL1 == AT32_CLKOUT_SEL1_HEXT) ||                          \
    ((AT32_CLKOUT_SEL1 == AT32_CLKOUT_SEL1_PLL) &&                          \
     (AT32_PLLRCS == AT32_PLLRCS_HEXT))
#error "HEXT not enabled, required by AT32_CLKOUT_SEL1"
#endif
...
#if AT32_CLKOUT_SEL2 == AT32_CLKOUT_SEL2_LICK
#error "LICK not enabled, required by AT32_CLKOUT_SEL2"
#endif
...
#if AT32_CLKOUT_SEL2 == AT32_CLKOUT_SEL2_LEXT
#error "LEXT not enabled, required by AT32_CLKOUT_SEL2"
#endif
 ...
 * @brief   USB clock.
 */
#if (AT32_PLLU_USB48_SEL == AT32_PLLU_USB48_SEL_PLLU) || defined(__DOXYGEN__)
