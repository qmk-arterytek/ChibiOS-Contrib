...
/**
 * @file    AT32F405/hal_lld.c
 * @brief   AT32F405 HAL subsystem low level driver source.
 *
 * @addtogroup HAL
 * @{
 */
 ...
 * @note    It is declared in system_at32f405.h.
 */
...
void at32_clock_init(void) {
  ...
  /* Clock settings.*/
  CRM->CFG   |= (AT32_CLKOUT_SEL1 & AT32_CLKOUT_SEL1_CFG_MASK) | AT32_APB2DIV     |
                 AT32_APB1DIV                                  | AT32_AHBDIV      |
                 AT32_ERTCDIV                                  | AT32_I2SF5CLKSEL |
                 AT32_CLKOUTDIV1;
  CRM->MISC1 |= (AT32_CLKOUT_SEL2 & AT32_CLKOUT_SEL2_MISC1_MASK) | AT32_CLKOUTDIV2;
