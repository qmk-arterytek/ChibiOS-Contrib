...
/**
 * @file    AT32F405/at32_registry.h
 * @brief   AT32F405 capabilities registry.
 *
 * @addtogroup HAL
 * @{
 */
...
#if defined(AT32F405KB)
#define AT32F405K_MD

#elif defined(AT32F405KC)
#define AT32F405K_HD

#elif defined(AT32F405CB)
#define AT32F405C_MD

#elif defined(AT32F405CC)
#define AT32F405C_HD

#elif defined(AT32F405RB)
#define AT32F405R_MD

#elif defined(AT32F405RC)
#define AT32F405R_HD
...
#if defined(AT32F405K_MD) || defined(__DOXYGEN__)
/**
 * @name    AT32F405K MD capabilities
 * @{
 */
/* ADC attributes.*/
...
/** @} */
#endif /* defined(AT32F405K_MD) */

#if defined(AT32F405K_HD) || defined(__DOXYGEN__)
/**
 * @name    AT32F405K HD capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_HAS_ADC1                      TRUE
...
#define AT32_WDT_IS_WINDOWED               TRUE
/** @} */
#endif /* defined(AT32F405K_HD) */

#if defined(AT32F405C_MD) || defined(__DOXYGEN__)
/**
 * @name    AT32F405C MD capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_HAS_ADC1                      TRUE
...
#define AT32_WDT_IS_WINDOWED               TRUE
/** @} */
#endif /* defined(AT32F405C_MD) */

#if defined(AT32F405C_HD) || defined(__DOXYGEN__)
/**
 * @name    AT32F405C HD capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_HAS_ADC1                      TRUE
...
#define AT32_WDT_IS_WINDOWED               TRUE
/** @} */
#endif /* defined(AT32F405C_HD) */

#if defined(AT32F405R_MD) || defined(__DOXYGEN__)
/**
 * @name    AT32F405R MD capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_HAS_ADC1                      TRUE
...
#define AT32_WDT_IS_WINDOWED               TRUE
/** @} */
#endif /* defined(AT32F405R_MD) */

#if defined(AT32F405R_HD) || defined(__DOXYGEN__)
/**
 * @name    AT32F405R HD capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_HAS_ADC1                      TRUE
