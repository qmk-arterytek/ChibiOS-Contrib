...
/** @addtogroup at32f405cx
  * @{
  */

#ifndef __AT32F405Cx_H
#define __AT32F405Cx_H
...
/**
  ...
  */
#define __AT32F405_LIBRARY_VERSION_MAJOR   (0x02) /*!< [31:24] major version */
#define __AT32F405_LIBRARY_VERSION_MIDDLE  (0x01) /*!< [23:16] middle version */
#define __AT32F405_LIBRARY_VERSION_MINOR   (0x00) /*!< [15:8]  minor version */
#define __AT32F405_LIBRARY_VERSION_RC      (0x00) /*!< [7:0]   release candidate */
#define __AT32F405_LIBRARY_VERSION         ((__AT32F405_LIBRARY_VERSION_MAJOR  << 24)\
                                           |(__AT32F405_LIBRARY_VERSION_MIDDLE << 16)\
                                           |(__AT32F405_LIBRARY_VERSION_MINOR  << 8 )\
                                           |(__AT32F405_LIBRARY_VERSION_RC))
...
/**
 * @brief AT32F405Cx Interrupt Number Definition, according to the selected device
...
/******  AT32 specific Interrupt Numbers **********************************************************/
  ...
  OTGHS_EP1_OUT_IRQn          = 74,     /*!< OTGHS Endpoint 1 OUT Interrupt                       */
  OTGHS_EP1_IN_IRQn           = 75,     /*!< OTGHS Endpoint 1 IN Interrupt                        */
  OTGHS_WKUP_IRQn             = 76,     /*!< OTGHS Wake Up Interrupt linked to EXINT20            */
  OTGHS_IRQn                  = 77,     /*!< OTGHS global Interrupt                               */
...
typedef struct
{
  ...
  uint32_t      RESERVED0[12];     /*!< Reserved,                                    Address offset: 0x050 ~ 0x07C */
  __IO uint32_t OVSP;              /*!< ADC oversampling register,                   Address offset: 0x080         */
  uint32_t      RESERVED1[135];    /*!< Reserved,                                    Address offset: 0x084 ~ 0x300 */
...
typedef struct
{
  ...
  __IO uint32_t OTGHS;           /*!< CRM OTGHS control register,                  Address offset: 0x78        */
...
typedef struct
{
  ...
  uint32_t      RESERVED0[62];    /*!< Reserved,                                    Address offset: 0x008 ~ 0x0FC */
  __IO uint32_t MUXSEL;           /*!< DMA multiplexed select register,             Address offset: 0x100         */
  uint32_t      RESERVED1[11];    /*!< Reserved,                                    Address offset: 0x104 ~ 0x12C */
...
typedef struct
{
  ...
  uint32_t      RESERVED[7];    /*!< Reserved,                                    Address offset: 0x54 ~ 0x6C */
  __IO uint32_t CM3;            /*!< TMR channel mode register 3,                 Address offset: 0x70 */
  __IO uint32_t C5DT;           /*!< TMR channel 5 data register,                 Address offset: 0x74 */
} TMR_TypeDef;
...
#define DMA1MUX_Channel1_BASE        (AHBPERIPH_BASE + 0x00006104U)  /*!< DMA1 Multiplexed Channel 1 base address        */
...
#define DMA2MUX_Channel1_BASE        (AHBPERIPH_BASE + 0x00006504U)  /*!< DMA2 Multiplexed Channel 1 base address        */
...
#define USB_HS_PHYC_CONTROLLER_BASE  (APB2PERIPH_BASE + 0x00007C00U) /*!< USB OTG HS PHY Controller base address         */
...
#define CRM_AHBRST1_OTGHSRST                CRM_AHBRST1_OTGHSRST_Msk                /*!< OTGHS reset */
...
#define CRM_APB2RST_OTGHSPHYRST_Pos         (31U)
#define CRM_APB2RST_OTGHSPHYRST_Msk         (0x1U << CRM_APB2RST_OTGHSPHYRST_Pos)   /*!< 0x80000000 */
#define CRM_APB2RST_OTGHSPHYRST             CRM_APB2RST_OTGHSPHYRST_Msk             /*!< OTGHS PHY reset */
...
#define CRM_AHBEN1_OTGHSEN                  CRM_AHBEN1_OTGHSEN_Msk                  /*!< OTGHS clock enable */
...
#define CRM_APB2EN_OTGHSPHYEN_Pos           (31U)
#define CRM_APB2EN_OTGHSPHYEN_Msk           (0x1U << CRM_APB2EN_OTGHSPHYEN_Pos)     /*!< 0x80000000 */
#define CRM_APB2EN_OTGHSPHYEN               CRM_APB2EN_OTGHSPHYEN_Msk               /*!< OTGHS PHY clock enable */
...
#define CRM_AHBLPEN1_OTGHSLPEN              CRM_AHBLPEN1_OTGHSLPEN_Msk              /*!< OTGHS clock enable in sleep mode */
...
#define CRM_APB2LPEN_OTGHSPHYLPEN_Pos       (31U)
#define CRM_APB2LPEN_OTGHSPHYLPEN_Msk       (0x1U << CRM_APB2LPEN_OTGHSPHYLPEN_Pos) /*!< 0x80000000 */
#define CRM_APB2LPEN_OTGHSPHYLPEN           CRM_APB2LPEN_OTGHSPHYLPEN_Msk           /*!< OTGHS PHY clock enable in sleep mode */
...
#define CRM_OTGHS_USBHS_PHY12_SEL           CRM_OTGHS_USBHS_PHY12_SEL_Msk           /*!< USBHS PHY 12M clock source select */
...
#define CRM_MISC2_PLLU_USB48_SEL            CRM_MISC2_PLLU_USB48_SEL_Msk            /*!< USBFS/USBHS 48M clock source selection */
